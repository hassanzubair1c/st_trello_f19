...
public class CreateNewTeam extends javax.swing.JFrame {
    ...
    public CreateNewTeam(User u1){
        user1=u1;
        //initTM();
        tm2=Team_Management.getinstancetillteamnames();
        initComponents();
        setResizable(false);
    }
    public void initTM(){
  ...
  String url = "jdbc:derby://localhost:1527/TrelloApp";
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
        ...
        if(!jTextField1.getText().equals("")){
            if(tm2.ispresentteam(jTextField1.getText())){
        ...
        try{
            myConnection = DriverManager.getConnection(url,"ubaid","12345");
            myStatement = myConnection.createStatement();
           myStatement.executeUpdate("Insert into AllTeams values ('"+jTextField1.getText()+"','"+user1.getEmail()+"')");
           myStatement.executeUpdate("create table "+jTextField1.getText()+"(Listnames varchar(30),Members varchar(30))"); 
           myStatement.executeUpdate("Insert into "+jTextField1.getText()+" (Members) values('"+user1.getEmail()+"')");
           tm2.addTeam(jTextField1.getText());
