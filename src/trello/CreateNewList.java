 ...
 * @author ubaidullah
 */
public class CreateNewList extends javax.swing.JFrame {
    ...
    public CreateNewList() {
     ...
     public CreateNewList(User u1,String tn){
        user1=u1;
        teamname=tn;
//        initTM();
        tm2=Team_Management.getinstancetilllistnames();
        initComponents();
        setResizable(false);
    }
    public void initTM(){
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
        ...
        if(!jTextField1.getText().equals("")){
            if(tm2.ispresentlist(teamname,jTextField1.getText())){
                ...
                try{
                    myConnection = DriverManager.getConnection(url,"ubaid","12345");
                    myStatement = myConnection.createStatement();
                    myStatement.executeUpdate("Insert into " +teamname +" (Listnames) values ('"+jTextField1.getText()+"')");
                    myStatement.executeUpdate("create table "+teamname +jTextField1.getText()+"(cardname varchar(30),description varchar(50),duedate varchar(15))");
                   
                    tm2.addlist(teamname, jTextField1.getText());

                    JOptionPane.showMessageDialog(this, "List added" );
