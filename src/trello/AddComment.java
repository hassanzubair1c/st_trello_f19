...
public class AddComment extends javax.swing.JFrame {
    ...
    public AddComment(String tn,String ln,String cn,User u1){
        user1=u1;
        teamname=tn;
        listname=ln;
        cardname=cn;
    ...
    private void jLabel2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MousePressed
        ...
        if(jTextArea1.getText().length()>=50){
            JOptionPane.showMessageDialog(this, "Please enter comment of less than 50 characters" );
        }
        else{
            ...
            try{
                ...
                myStatement.executeUpdate("insert into "+teamname+listname+cardname+" (comments) values ('"+user1.getName()+" commented \""+jTextArea1.getText()+"\"')");
