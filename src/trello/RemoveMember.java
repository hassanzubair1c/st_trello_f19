...
public class RemoveMember extends javax.swing.JFrame {
    ...
    public RemoveMember(User u1,String x){
        user1=u1;
        ...
        if(!jTextField1.getText().equals("")){
            if(um.CheckEmail(jTextField1.getText())){
                ...
                try{
                    ...
                    if(!myResult2.next()){
                        myStatement2.executeUpdate("Delete from "+teamname+" where Members='"+jTextField1.getText()+"'");
                        ...
                        JOptionPane.showMessageDialog(this, "The user is not the part of the team" );
                    }
                }
                catch(Exception e){
                    e.printStackTrace();
